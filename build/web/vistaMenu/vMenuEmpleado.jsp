...
<div id="sidebar" class="shadow">
    <%
        ...
        Empleado t = (Empleado) session.getAttribute("empleado");
        if (t == null) {
            response.sendRedirect("../index.jsp?msg=sesioninvalida"); // Redirige si no hay sesión
            return;
        }
    %>
    ...
    <nav class="sidebar-nav nav flex-column px-1" id="sidebarNav">
        ...
        <a class="nav-link" href="<%= request.getContextPath()%>/vistaEmpleado/vListEmpleado.jsp">
            <i class="bi bi-speedometer2"></i>
            <span class="label">Administración</span>
        </a>

        <a class="nav-link" href="<%= request.getContextPath()%>/vistaEmpleado/vListarCliente.jsp">
            <i class="bi bi-people"></i>
            <span class="label">Clientes</span>
        </a>

        <a class="nav-link" href="<%= request.getContextPath()%>/vistaEmpleado/vListEvento.jsp">
            <i class="bi bi-calendar2-event"></i>
            <span class="label">Eventos</span>
        </a>

        <a class="nav-link" href="<%= request.getContextPath()%>/vistaEmpleado/vListaProveedores.jsp">
